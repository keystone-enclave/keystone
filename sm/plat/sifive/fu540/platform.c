...
static int
fu540_final_init(bool cold_boot) {
  void* fdt;
...
static int
fu540_irqchip_init(bool cold_boot) {
  int rc;
...
static u64
fu540_get_tlbr_flush_limit(void) {
  return FU540_TLB_RANGE_FLUSH_LIMIT;
}

static int
fu540_timer_init(bool cold_boot) {
  int rc;
