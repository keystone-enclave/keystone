...
void
swap_prev_state(
    struct thread_state* state, struct sbi_trap_regs* regs,
    int return_on_resume);
void
swap_prev_mepc(
    struct thread_state* state, struct sbi_trap_regs* regs, uintptr_t mepc);
void
swap_prev_mstatus(
    struct thread_state* state, struct sbi_trap_regs* regs, uintptr_t mstatus);
void
