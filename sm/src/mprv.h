...
int
copy1_from_sm(uintptr_t dst, const uint8_t* src);
int
copy_word_from_sm(uintptr_t dst, const uintptr_t* src);
int
copy_block_from_sm(uintptr_t dst, const mprv_block* src);

int
copy1_to_sm(uint8_t* dst, uintptr_t src);
int
copy_word_to_sm(uintptr_t* dst, uintptr_t src);
int
copy_block_to_sm(mprv_block* dst, uintptr_t src);
...
static inline int
copy_from_sm(uintptr_t dst, void* src_buf, size_t len) {
...
static inline int
copy_to_sm(void* dst_buf, uintptr_t src, size_t len) {
