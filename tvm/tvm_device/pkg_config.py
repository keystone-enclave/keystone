    ...
    def __init__(self, cfg):
        ...
        if self.TARGET == "de10nano":
            ...
            self.store_base_addr = "0xA0003000"
                ...
                # todo dunno about these
                self.fpga_log_axi_bus_width = 6
                self.axi_prot_bits = '010'

                # IP register address map. Note that these are not actually
                # used in the driver, since they correspond to the HLS interface.
                self.ip_reg_map_range = "0x1000"
                self.fetch_base_addr = "0x60020000"
                self.load_base_addr = "0x60021000"
                self.compute_base_addr = "0x60022000"
                self.store_base_addr = "0x60023000"
        else:
